...
import frc.robot.commands.Auto.trajectories.driveForwardVolts;
import frc.robot.commands.Auto.trajectories.followPath;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    configureButtonBindings();
      ...
      m_chooser.addOption("test Volts", new driveForwardVolts());
      m_chooser.addOption("follow path",  followPath.getAutoCommand());
