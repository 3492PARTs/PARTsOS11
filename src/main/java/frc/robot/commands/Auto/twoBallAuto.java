...
public class twoBallAuto extends SequentialCommandGroup {
  ...
  public twoBallAuto() {
    ...
    addCommands(new Delay(), 
       new ParallelCommandGroup( new LowerIntake(), new autoShooting(.98), new SequentialCommandGroup(new WaitCommand(.5), new Index())), new turnRobo(-10), new ParallelRaceGroup(new PIDDrive(32 , .8), new IntakeCom()), new PIDDrive(-32, .75), new ParallelCommandGroup(new turnRobo(15), new ParallelRaceGroup(new autoShooting(.98), new Index(), new IntakeCom())),  new ParallelCommandGroup(new flipFast(), new RaiseIntake()),
